...
packages to the native toolchain version. The MCP template also pins
`@tysel/sdk` for schema-driven handler inference. Tysel runtime and test
commands work immediately without installing them. If you want editor
declarations and the additional TypeScript compiler pass, install the generated
development dependencies with your preferred package manager, for example:
