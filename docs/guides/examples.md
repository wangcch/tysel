...
| [Rust Component starter](wasm-component-rust.md) | One-shot JSON task, no ambient WASI | `printf '{"value":42}' \| tysel run` | `component`; JSON task; no ambient WASI; experimental |
| [Go Component starter](wasm-component-go.md) | Same world with committed Go bindings | `printf '{"value":42}' \| tysel run` | `component`; JSON task; no ambient WASI; experimental |
