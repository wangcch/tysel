...
description: "Tysel treats host authority as an explicit contract. Network destinations, secret names, database grants, filesystem roots, limits, and execution profile are declared in the versioned TOML or JSON application manifest an"
---
...
Continue with the [capability matrix](/docs/capabilities),
[execution profiles](/docs/concepts/execution-profiles), and
[Wasm Component capabilities](/reference/component/capabilities), or the
