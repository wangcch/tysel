...
description: "Tysel denies undeclared resources. A declaration is a request, not a guarantee: the execution profile and deployment policy can reduce authority further. The isolated profile denies host-facing capabilities even if the m"
---
...
[`tysel:fs/read@0.4.0` and `tysel:fs/write@0.4.0`](/reference/component/capabilities).
...
[execution profiles](/docs/concepts/execution-profiles),
[manifest reference](/reference/manifest), and
