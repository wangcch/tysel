...
description: "Tysel denies undeclared resources. A declaration is a request, not a guarantee: the execution profile and deployment policy can reduce authority further."
---
