...
description: "A Tysel project is a directory containing exactly one application manifest: `tysel.toml` or `tysel.json`. Both formats use the same versioned schema. A neighboring `package.json` is optional and never overrides Tysel con"
---
