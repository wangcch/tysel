...
description: "This runbook describes the production deployment contract for applications built with an installed Tysel release. Linux x86-64 (linux-x64) and Linux arm64 (linux-arm64) are the supported production targets."
---
...
[Reproducible application releases](/docs/guides/reproducible-release) for the
...
non-root contract, follow [Build a container image](/docs/guides/container-image).
...
The [Observability guide](/docs/guides/observability) lists the exact signal,
...
Use [Debug service failures](/docs/guides/debugging) to distinguish runtime
