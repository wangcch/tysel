---
title: "Filesystem"
description: "This guide grants two directory roots, transforms one UTF-8 JSON file, writes the result beneath a separate output root, and verifies that paths outside the allowlist remain denied."
---
...
- `component` uses versioned WIT imports and also requires an explicit packaged
  deployment grant; see [Component capabilities](/reference/component/capabilities).
...
See [Filesystem permissions](/reference/manifest/permissions#filesystem),
[Host capabilities](/reference/runtime/capabilities#filesystem), and
[Limits and defaults](/reference/limits-and-defaults#data-capabilities).
