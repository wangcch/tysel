...
description: "This guide configures service workers and HTTP admission so overload is bounded and visible instead of becoming an unbounded queue."
---
...
See [Application limits](/reference/manifest/limits),
