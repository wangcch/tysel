...
description: "The repository examples are runnable acceptance paths, not isolated snippets. Each tree includes source, a manifest, and the exact commands used to verify it. The website catalog at `/examples` presents the same set as a"
---
