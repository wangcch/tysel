---
title: "Reproducible release"
description: "This guide builds one Tysel application artifact set and follows its evidence through signing. It separates deterministic application evidence from the Tysel toolchain's two-build release process."
---
...
See [Release evidence commands](/reference/cli/evidence),
[Build command](/reference/cli/delivery#tysel-build), and
[Production build admission](/docs/operations/production#build-admission).
