...
description: "The final image contains one Tysel executable. It does not need Tysel, Node.js, npm, or node_modules at runtime."
---
...
| Component profile is rejected | Package the one-shot executable using [Component tasks](/docs/operations/component-tasks). |
