---
title: "SQLite"
description: "This guide configures the runtime-owned SQLite client, executes parameterized statements, verifies persistence, and separates the application database from the durable event log."
---
...
[production storage guidance](/docs/operations/production#durable-postgres-backup-and-restore)
...
See the [SQLite API](/reference/runtime/capabilities#sql),
[durable configuration](/reference/manifest/durable-observability), and
[data capability limits](/reference/limits-and-defaults#data-capabilities).
