...
| --- | --- | --- |
| <code>{"--error-format <human\|json>"}</code> | `human` | Format stderr errors; JSON mode also emits the `dev` diagnostic stream. |
...
| Development | [`check`, `types`, `compat`, `test`, `dev`, `run`, `inspect`](/reference/cli/development) |
