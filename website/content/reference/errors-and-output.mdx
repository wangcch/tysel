---
title: "Errors and machine output"
description: "Tysel separates human diagnostics from stable JSON envelopes. Automation should select a machine-readable mode explicitly and parse stdout and stderr independently."
---
...
See [Component ABI](/reference/component/abi) and
[Component runtime limits](/reference/component/runtime#resource-bounds).

See [Debug service failures](/docs/guides/debugging),
[Application module](/reference/runtime/application), [Application limits](/reference/manifest/limits),
