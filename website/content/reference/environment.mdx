...
description: "Environment variables configure the host and installation, not application JavaScript. The runtime filters application access: declaring a secret makes an opaque reference available through `tysel.secrets`, not through"
---
...
and [Production operations](/docs/operations/production).
