...
description: "This page collects limits that otherwise span the manifest, protocols, and host implementations. Manifest values are configuration contracts. Entries marked **implementation bound** describe the current runtime and may e"
---
