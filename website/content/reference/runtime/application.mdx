...
description: "An application default-exports a TyselApp object. It must expose at least one HTTP, task, or durable entrypoint; the selected command or protocol requires the corresponding handler."
---
