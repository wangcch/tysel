...
description: "An application default-exports a TyselApp object. It must declare at least one HTTP, task-registry, or durable-registry entrypoint group; the selected command or protocol still requires a concrete handler in that group."
---
