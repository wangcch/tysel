...
description: "Host methods live on globalThis.tysel. Type availability does not grant authority: the execution profile, manifest permission, and host configuration must all permit the call."
---
