...
| Application | `FetchHandler`, `CronTask`, `QueueTask`, `McpInputSchema`, `McpTask`, `AppTask`, `TyselApp` | [Application module](/reference/runtime/application) |
...
| Runtime host | `TyselRuntime`, `Tysel` | [Runtime overview](/reference/runtime) |
