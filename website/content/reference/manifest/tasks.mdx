---
title: "Manifest tasks"
description: "The optional [tasks] map defines project workflows as Tysel argument vectors, without a platform shell or package.json scripts."
---
...
See [`tysel task`](/reference/cli/tasks) for invocation and
