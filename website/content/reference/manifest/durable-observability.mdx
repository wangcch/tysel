---
title: "Durable storage and observability"
description: "The optional durable table selects the event store used by durable handlers."
---
...
See [Durable API](/reference/runtime/durable), [Durable execution](/docs/concepts/durable-execution),
and [Production operations](/docs/operations/production) for replay and
backup requirements.
...
See [Environment variables](/reference/environment) for supported OpenTelemetry
controls and [Production operations](/docs/operations/production) for
