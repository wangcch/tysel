...
description: "Use the guest SDK source and WIT package vendored in the Component starter bundle for the installed Tysel release. The starter module already uses a local replacement."
---
