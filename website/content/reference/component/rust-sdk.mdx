...
description: "Status: **experimental and workspace-local**. `tysel-component-sdk` is not yet published as a stable crates.io dependency. Use the SDK and WIT files from the same Tysel source revision as the runtime."
---
...
Follow [Build a Rust Component](/docs/guides/wasm-component-rust) for the
tested commands and [Component ABI](/reference/component/abi) for host validation.
